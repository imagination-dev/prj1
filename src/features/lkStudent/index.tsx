...
const LkStudent = () => {
    ...
    const dots = Array.from({length: swiperData.length}, (a, b) => b)
            ...
            <>
                ...
                <div className={s.swiper_box}>
                    <div className={s.navigate}>
                        <div className={s.arrow} onClick={() => swiperRef?.current?.slidePrev()}><ArrowLeftOutlinedIcon
                            style={{height: '32px', width: 'auto'}}/></div>
                        <div className={s.arrow} onClick={() => swiperRef.current?.slideNext()}><ArrowRightOutlinedIcon
                            style={{height: '32px', width: 'auto'}}/></div>
                    </div>
                    <Swiper
                        onSwiper={(swiper) => {
